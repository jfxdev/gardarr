...
func NewModule(router *gin.RouterGroup, db *database.Database, service *transferreport.Service) *Module {
	return &Module{group: router.Group("/reports/transfer"), db: db, service: service}
}
